cask "parallels-desktop@19.0" do
  ...
  auto_updates true
  conflicts_with cask: [
    "homebrew/cask-versions/parallels@12",
    "homebrew/cask-versions/parallels@13",
    "homebrew/cask-versions/parallels@14",
    "homebrew/cask-versions/parallels@15",
    "homebrew/cask-versions/parallels@16",
